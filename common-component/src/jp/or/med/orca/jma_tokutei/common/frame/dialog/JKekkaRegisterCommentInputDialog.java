...
public class JKekkaRegisterCommentInputDialog extends JKekkaRegisterAbstractInputDialog
{
    ...
    public JKekkaRegisterCommentInputDialog(Frame frame, String s)
    {
        super(frame);
        TEIKEIBUN_TEXT = null;
        jListComment = null;
...
//            final JKekkaRegisterCommentInputDialog this$0;
//
//
//            {
//                this$0 = JKekkaRegisterCommentInputDialog.this;
//                super();
//            }
        });
    ...
    private static Logger logger = Logger.getLogger("jp/or/med/orca/jma_tokutei/common/frame/dialog/JKekkaRegisterCommentInputDialog");
