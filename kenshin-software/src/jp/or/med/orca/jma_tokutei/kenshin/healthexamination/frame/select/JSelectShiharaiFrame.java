...
public class JSelectShiharaiFrame extends JDialog implements ActionListener,KeyListener
{
	 ...
	 */
	public JSelectShiharaiFrame() {
		super();
		initialize(null);
	}
	public JSelectShiharaiFrame(String title) {
		super();
		initialize(title);
	}
	/**
...
//			jPanel_ButtonArea.add(getJButton_End(), null);
			...
			jPanel_ButtonArea.setBorder(BorderFactory.createEmptyBorder(5, 0, 0, 0));
...
//	}
	...
	private JPanel getJPanel_ExplArea2() {
		if (jPanel_ExplArea2 == null) {
			...
			// jLabal_SubExpl.setText("保険者を選択してください。");
...
//			jButton_Select.addKeyListener(this);
			...
			ImageIcon icon = iIcon.setStrechIcon(this, JPath.CONST_FIX_ICON);
			jButton_Select= new ExtendedButton(
					"Select","選択(S)","選択(ALT+S)",KeyEvent.VK_S,icon);
			jButton_Select.addActionListener(this);
		}
