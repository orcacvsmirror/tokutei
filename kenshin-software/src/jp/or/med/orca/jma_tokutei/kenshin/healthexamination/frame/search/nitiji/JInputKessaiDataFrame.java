...
public class JInputKessaiDataFrame extends JFrame implements ActionListener,ItemListener,KeyListener {
	...
	protected ExtendedLabel jLabel60 = null;
	...
	protected ExtendedButton jButton_PrintRyosyu = null;

	protected ExtendedTextField jTextField_DocTanka = null;
	/* ÉtÉHÅ[ÉJÉXà⁄ìÆêßå‰ */
//	private JFocusTraversalPolicy focusTraversalPolicy = null;  //  @jve:decl-index=0:	// edit n.ohkubo 2014/10/01Å@ñ¢égópÇ»ÇÃÇ≈çÌèú
...
//		this.focusInitialize();
	...
	private JPanel getJPanel_Content() {
		if (jPanel_Content == null) {
			...
			jLabel_Title = new TitleLabel("tokutei.inputkessai.frame.title","tokutei.inputkessai.frame.guidance");
			jLabel_Title.setFont(new Font("ÇlÇr ÉSÉVÉbÉN", Font.PLAIN, 14));
...
//			gridBagConstraints113.anchor = GridBagConstraints.EAST;
			...
			jPanel_ButtonArea.add(getJButton_Register(), gridBagConstraints115);
//			jPanel_ButtonArea.add(getJButton_Cancel(), gridBagConstraints114);
			// add s.inoue 2012/01/26
			jPanel_ButtonArea.add(getJButton_PrintRyosyu(), gridBagConstraints114);

			jPanel_ButtonArea.add(getJButton_End(), gridBagConstraints116);
			// add s.inoue 2012/11/13
			jPanel_ButtonArea.add(getJPanel_TitleArea(), gridBagConstraints112);
...
//			 jPanel_TitleArea.add(buttonBox, gridBagConstraints26);
	...
	/**
	 * This method initializes jButton_PrintRyosyu
	 *
	 * @return javax.swing.ExtendedButton
	 */
	private ExtendedButton getJButton_PrintRyosyu() {
		if (jButton_PrintRyosyu == null) {
			...
			jButton_PrintRyosyu= new ExtendedButton(
					"End","óÃé˚èë(P)","óÃé˚èë(ALT+P)",KeyEvent.VK_P,icon);
			jButton_PrintRyosyu.addActionListener(this);
			jButton_PrintRyosyu.setVisible(false);
		}
		return jButton_PrintRyosyu;
	}
...
//			jButton_End.addActionListener(this);
			...
			ImageIcon icon = iIcon.setStrechIcon(this, JPath.CONST_FIX_ICON);
			jButton_End= new ExtendedButton(
					"End","ñﬂÇÈ(R)","ñﬂÇÈ(ALT+R)",KeyEvent.VK_R,icon);
			jButton_End.addActionListener(this);
		}
		return jButton_End;
	}
...
//	}
	...
	// edit n.ohkubo 2014/10/01Å@ñ¢égópÇ»ÇÃÇ≈çÌèú
...
//	}
	...
	private JPanel getJPanel_DrawArea() {
		if (jPanel_DrawArea == null) {
			...
			jLabel6.setHtmlText("<b>í«â¡åíêfçÄñ⁄Åiì‡ñÛÅj</b>");
...
//			gridBagConstraints17.gridx = 7;	// edit n.ohkubo 2014/10/01Å@çÌèú
			gridBagConstraints17.gridx = 9;	// edit n.ohkubo 2014/10/01Å@í«â¡
...
//			gridBagConstraints14.gridx = 9;	// edit n.ohkubo 2014/10/01Å@çÌèú
			gridBagConstraints14.gridx = 7;	// edit n.ohkubo 2014/10/01Å@í«â¡
...
//			GridBagConstraints gridBagConstraints800 = new GridBagConstraints();
//			gridBagConstraints800.anchor = GridBagConstraints.WEST;
//			gridBagConstraints800.gridx = 0;
//			gridBagConstraints800.gridy = 8;
...
//			gridBagConstraints3.gridy = 0;
			...
			jLabel60 = new ExtendedLabel();
			jLabel60.setText("é¿é{ì˙");
			...
			jPanel1.add(jLabel60, gridBagConstraints18);
	...
	private ExtendedTextField getJTextField_Jyusinken_ID() {
		if (jTextField_Jyusinken_ID == null) {
			...
			// eidt s.inoue 2012/05/15 150 Å® 110
	...
	private JPanel getJPanel17() {
		if (jPanel17 == null) {
			...
			jLabel7.setHtmlText("<b>àœëıóøíPâøãÊï™</b>");
...
//			jButton_Register.addActionListener(this);
			...
			ImageIcon icon = iIcon.setStrechIcon(this, JPath.CONST_FIX_ICON);
			jButton_Register= new ExtendedButton(
					"Register","ìoò^(S)","ìoò^(ALT+S)",KeyEvent.VK_S,icon);
			jButton_Register.addActionListener(this);
		}
...
//			ImageIcon icon = iIcon.setStrechIcon(this, JPath.CONST_FIX_ICON);
//			jButton_Cancel= new ExtendedButton(
//					"Cancel","ÉLÉÉÉìÉZÉã(C)","ÉLÉÉÉìÉZÉã(ALT+C)",KeyEvent.VK_C,icon);
//			jButton_Cancel.addActionListener(this);
//		}
...
//			jButton_ReCalc.addActionListener(this);
			ExtendedImageIcon iIcon = new ExtendedImageIcon(JPath.Ico_Seikyu_Calc);
			ImageIcon icon = iIcon.setStrechIcon(this, JPath.CONST_FIX_ICON);
			jButton_ReCalc= new ExtendedButton(
					"Recalc","çƒåvéZ(C)","çƒåvéZ(ALT+C)",KeyEvent.VK_C,icon);
			jButton_ReCalc.addActionListener(this);
		}
	...
	private JPanel getJPanel210() {
		if (jPanel210 == null) {
			...
			jLabel_ningenDoc.setHtmlText("<b>êlä‘ÉhÉbÉN</b>");
			GridBagConstraints gridBagConstraints114 = new GridBagConstraints();
			...
			jLabel_kingaku1.setHtmlText("<center><b>ï€åØé“ïâíS<br>è„å¿äz</b></center>");
			...
			jLabel_sonotaFutangaku.setHtmlText("<center><b>ÇªÇÃëºÇÃåíêfÇ…<br>ÇÊÇÈïâíSã‡äz</b></center>");
			...
			jLabel_kingakuInput.setHtmlText("<center><b>ëãå˚ïâíS<br>ÅiéÛêfåîèÓïÒÅj</b></center>");
...
//			jLabel155.setVisible(false);
			...
			jLabel_goukei.setHtmlText("<b>çáåv</b>");
			...
			jLabel_tsuika.setHtmlText("<b>í«â¡åíêf</b>");
			...
			jLabel_syousai.setHtmlText("<b>è⁄ç◊Ç»åíêf</b>");
			GridBagConstraints gridBagConstraints58 = new GridBagConstraints();
			gridBagConstraints58.gridx = 0;
			gridBagConstraints58.gridy = 1;
			jLabel_kihon = new ExtendedLabel();
			jLabel_kihon.setHtmlText("<b>äÓñ{ìIÇ»åíêf</b>");
			...
			jLabel_kingaku.setHtmlText("<center><b>ëãå˚ïâíSã‡äz<br>Åié¿ç€ÇÃïâíSäzÅj</b></center>");
			GridBagConstraints gridBagConstraints56 = new GridBagConstraints();
			gridBagConstraints56.gridx = 6;
			gridBagConstraints56.gridy = 0;
			jLabel_syubetu = new ExtendedLabel();
			jLabel_syubetu.setHtmlText("<center><b>éÛêfé“ÇÃ<br>ëãå˚ïâíS</b></center>");
			GridBagConstraints gridBagConstraints50 = new GridBagConstraints();
			gridBagConstraints50.gridx = 3;
			gridBagConstraints50.gridy = 0;
			jLabel_tanka = new ExtendedLabel();
			jLabel_tanka.setHtmlText("<b>íPâø</b>");
...
//			jLabel14.setVisible(false);
			...
			jLabel23.setHtmlText("<b>êøãÅã‡äz</b>");
