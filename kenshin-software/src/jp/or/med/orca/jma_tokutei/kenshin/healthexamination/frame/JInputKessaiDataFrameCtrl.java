...
//				Integer.valueOf(resultItem.get("MADO_FUTAN_S_SYUBETU"));
//			Integer madoguchiFutanTsuikaSyubetu =
//				Integer.valueOf(resultItem.get("MADO_FUTAN_T_SYUBETU"));
//
//			jComboBox_MadoguchiKihonSyubetu.setSelectedIndex(
//					madoguchiFutanKihonSyubetu);
//			jComboBox_MadoguchiSyousaiSyubetu.setSelectedIndex(
//					madoguchiFutanSyousaiSyubetu);
//			jComboBox_MadoguchiTsuikaSyubetu.setSelectedIndex(
//					madoguchiFutanTsuikaSyubetu);
//
//			validatedData.setMadoguchiKihonSyubetu(
//					jComboBox_MadoguchiKihonSyubetu.getSelectedIndex());
//			validatedData.setMadoguchiSyousaiSyubetu(
//					jComboBox_MadoguchiSyousaiSyubetu.getSelectedIndex());
//			validatedData.setMadoguchiTsuikaSyubetu(
//					jComboBox_MadoguchiTsuikaSyubetu.getSelectedIndex());
//
//		// edit s.inoue 2010/02/10
//		}else if (tankaHantei.equals(TANKA_HANTEI_DOC)){
