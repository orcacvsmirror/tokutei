 ...
 * 定型文マスタメンテナンス画面
 */
public class JShokenMasterMaintenanceEditFrame extends JFrame implements ActionListener,KeyListener,MouseListener {
...
//	protected ExtendedComboBox jCombobox_TeikeibunType = null;
	 ...
	 */
	public JShokenMasterMaintenanceEditFrame() {
		super();
		initialize();
	}
	...
	protected JPanel getJPanel_Content() {
		if (jPanel_Content == null) {
			...
			jLabel_Title = new TitleLabel("tokutei.teikei-mastermaintenance-edit.frame.title","tokutei.teikei-mastermaintenance-edit.frame.guidance");
...
//	}
	...
	private JPanel getJPaneTeikei() {
		if (jPanel_Teikei == null) {
			...
			jLabel1TeikeiNo.setForeground(ViewSettings.getRequiedItemFrColor());
