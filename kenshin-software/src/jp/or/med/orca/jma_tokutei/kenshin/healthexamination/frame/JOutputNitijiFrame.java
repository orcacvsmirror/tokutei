...
//    protected ExtendedTextField jTextField_HL7EndDate = null;
    ...
    // add ver2 s.inoue 2009/08/04
    protected JPanel jPanel_TankaTableArea = null;
...
//	protected ExtendedTextField jTextField_SeikyuGoukei = null;
	...
	if (jPanel_Content == null) {
	    ...
	    //jPanel_Content.add(getJPanel4(), BorderLayout.SOUTH);
...
//	    gridBagConstraints30.gridx = 5;
	...
	if (jPanel_NaviArea == null) {
	    ...
	    jLabel_Title = new TitleLabel("tokutei.nitiji.frame.title");
