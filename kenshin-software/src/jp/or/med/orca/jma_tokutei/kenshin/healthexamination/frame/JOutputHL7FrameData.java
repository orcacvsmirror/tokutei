...
// * コメント追加
// */
//public class JOutputHL7FrameData {
...
//		this.isValidateAsDataSet = false;
//		this.JissiBeginDate = JValidate.validateDate(jissibeginDate);
//
...
//		this.isValidateAsDataSet = false;
//		this.JissiEndDate = JValidate.validateDate(jissiendDate);
//
...
//		this.isValidateAsDataSet = false;
//		this.HL7BeginDate = JValidate.validateDate(beginDate);
//
...
//		this.isValidateAsDataSet = false;
//		this.HL7EndDate = JValidate.validateDate(endDate);
//
