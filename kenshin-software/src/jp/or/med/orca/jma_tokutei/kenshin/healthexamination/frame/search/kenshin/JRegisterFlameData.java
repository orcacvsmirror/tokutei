...
public class JRegisterFlameData {
	...
	public boolean setSeikyuKubun(String seikyuKubun) {
		this.isValidateAsDataSet = false;
		this.seikyuKubun = JValidate.validateSeikyuKubunCode(seikyuKubun);
	...
	public  boolean setMetaboHantei(String metaboHantei) {
		this.isValidateAsDataSet = false;
		this.metaboHantei = JValidate.validateMetaboHanteiKubunCode(metaboHantei);
	...
	public boolean setHokenSidouLevel(String hokenSidouLevel) {
		this.isValidateAsDataSet = false;
		this.hokenSidouLevel = JValidate.validateHokenSidouLevelCode(hokenSidouLevel);
