...
public class JSelectHokenjyaFrame extends JDialog implements ActionListener,KeyListener
{
	 ...
	 */
	public JSelectHokenjyaFrame() {
		super();
		initialize(null);
	}
	public JSelectHokenjyaFrame(String title) {
		super();
		initialize(title);
	}
	/**
