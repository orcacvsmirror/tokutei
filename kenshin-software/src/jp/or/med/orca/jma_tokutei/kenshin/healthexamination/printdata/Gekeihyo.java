...
public class Gekeihyo {
	 ...
	 * @return	boolean
	 */
	public boolean setPrintSeikyuGetujiDataSQL(Hashtable<String, String> data) throws SQLException{
		...
		// if(ResultItem.get("HENKAN_NITIJI") != null){
			...
			this.SeikyuData.put("HENKAN_NITIJI",
					...
					+ date.substring(4, 6) + "月"
					+ date.substring(6, 8) + "日");
			this.SeikyuData.put("HENKAN_NITIJI", date);
		}
	 ...
	 */
	public Hashtable<String, String> getPrintGekeiData(){
