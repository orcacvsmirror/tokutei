...
//
//public class CopyOfPrintDefine {
//
...
//	
//	// add s.inoue 2014/02/19
//	public static final String HOLTER_SINDENZU_UMU = "9A150160700000011";	//ホルター型心電図検査(所見の有無)
//	public static final String HOLTER_SINDENZU_VAL = "9A150160800000049";	//ホルター型心電図検査(所見)
//	public static final String MASTER_FUKA_UMU = "9A300160700000011";	//マスター2段階負荷試験(所見の有無)
//	public static final String MASTER_FUKA_VAL = "9A300160800000049";	//マスター2段階負荷試験(所見)
//	public static final String TREDMIRU_SINDENZU_UMU = "9A320160700000011";	//トレッドミル負荷心機能検査(所見の有無)
//	public static final String TREDMIRU_SINDENZU_VAL = "9A320160800000049";	//トレッドミル負荷心機能検査(所見)
//	public static final String ERUGOMETER_SINDENZU_UMU = "9A340160700000011";	//エルゴメーター負荷心機能検査(所見の有無)
//	public static final String ERUGOMETER_SINDENZU_VAL = "9A340160800000049";	//エルゴメーター負荷心機能検査(所見)
//	public static final String SINPAI_FUKA_UMU = "9A350160700000011";	//心肺運動負荷試験(所見の有無)
//	public static final String SINPAI_FUKA_VAL = "9A350160800000049";	//心肺運動負荷試験(所見)
//	public static final String CHOKUCHO_NAISIKYO_UMU = "9I200160700000011";	//直腸内視鏡検査(所見の有無)
//	public static final String CHOKUCHO_NAISIKYO_VAL = "9I200160800000049";	//直腸内視鏡検査(所見)
//	
//	public static final String KOTUEN_DXA_VAL = "9Z5060000Z9125049";	//骨塩定量(DPA法)
//	public static final String KOTUEN_DEX_VAL = "9Z5070000Z9225049";	//骨塩定量(DXA/DEX法)判定
//	public static final String KOTUEN_MD_VAL = "9Z5110000Z9399149";	//骨塩定量(MD法)判定
//	public static final String KOTUEN_CXD_VAL = "9Z5120000Z9499149";	//骨塩定量(CXD法)判定
//	public static final String KOTUEN_DIP_VAL = "9Z5130000Z9599149";	//骨塩定量(DIP法)判定
//	public static final String KOTUEN_QCT_VAL = "9Z5210000Z9625049";	//骨塩定量(QCT/pQCT法)判定
//	public static final String KOTUEN_US_VAL = "9Z5260000Z9725049";	//骨塩定量(US法)判定
//	public static final String KOTUEN_PWV_VAL = "Z9A43Z010Z9725049";	//脈波伝播速度baPWV(判定・所見)
//	public static final String KOTUEN_PWV_OLD_VAL = "Z9A43Z010Z97250ZA";	//脈波伝播速度baPWV血管年齢
//	public static final String KEIDOMYAKU_VAL = "Z9F120000Z9725049";	//頚動脈エコー所見
//	public static final String SIDOUJICYUI_VAL = "ZGGA1000000000049";	//指導時注意事項
//	// add s.inoue 2014/02/19
//	
//	public static final String TOUBU_CT_UMU = "Z9N21160700000011";	//頭部CT検査(所見の有無)
//	public static final String TOUBU_MRI_UMU = "Z9N22160700000011";	//頭部MRI検査(所見の有無)
//	public static final String FUKUBU_CT_UMU = "Z9N26160700000011";	//腹部CT検査(所見の有無)
//	public static final String FDG_PET_UMU = "Z9N29160700000011";	//FDG-PET検査(所見の有無)
//
//	// add s.inoue 2014/02/19
//	public static final String TOUBU_CT_VAL = "Z9N21160800000049";	//頭部CT検査(所見)
//	public static final String TOUBU_MRI_VAL = "Z9N22160800000049";	//頭部MRI検査(所見)
//	public static final String FUKUBU_CT_VAL = "Z9N26160800000049";	//腹部CT検査(所見)
//	public static final String FDG_PET_VAL = "Z9N29160800000049";	//FDG-PET検査(所見)
//	
//	public static final String DAICHO_NAISIKYO_UMU = "ZI200160700000011";	//大腸内視鏡検査(所見の有無)
//	public static final String SJYO_NAISIKYO_UMU = "ZI201160700000011";	//S状結腸内視鏡検査(所見の有無)
//	public static final String CHUCHO_ZOUKEI_UMU = "ZI210160700000011";	//注腸造影検査(所見の有無)
//	public static final String CHOKUCHO_UMU = "ZI220160700000011";	//直腸診(所見の有無)
//	
//	// add s.inoue 2014/02/19
//	public static final String DAICHO_NAISIKYO_VAL = "ZI200160800000049";	//大腸内視鏡検査(所見)
//	public static final String SJYO_NAISIKYO_VAL = "ZI201160800000049";	//S状結腸内視鏡検査(所見)
//	public static final String CHUCHO_ZOUKEI_VAL = "ZI210160800000049";	//注腸造影検査(所見)
//	public static final String CHOKUCHO_VAL = "ZI220160800000049";	//直腸診(所見)
//	
...
//
//	public static final String FUKUYAKU1_VAL = "9N646000000000049";	//服薬1(血圧)(薬剤名)
//	public static final String FUKUYAKU1_RIYU_VAL = "9N646000000000049";	//服薬1(血圧)(実施理由)
//	public static final String FUKUYAKU2_VAL = "9N646000000000049";	//服薬2(血糖)(薬剤名)
//	public static final String FUKUYAKU2_RIYU_VAL = "9N646000000000049";	//服薬2(血糖)(実施理由)
//	public static final String FUKUYAKU3_VAL = "9N646000000000049";	//服薬3(脂質)(薬剤名)
//	public static final String FUKUYAKU3_RIYU_VAL = "9N646000000000049";	//服薬3(脂質)(実施理由)
//	
...
//		
//		// add s.inoue 2014/02/19 足りなかった分add
//		syokenUmu.add(HOLTER_SINDENZU_UMU);   //ホルター型心電図検査(所見の有無)
//		syokenUmu.add(MASTER_FUKA_UMU);   //マスター2段階負荷試験(所見の有無)
//		syokenUmu.add(TREDMIRU_SINDENZU_UMU);   //トレッドミル負荷心機能検査(所見の有無)
//		syokenUmu.add(ERUGOMETER_SINDENZU_UMU);   //エルゴメーター負荷心機能検査(所見の有無)
//		syokenUmu.add(SINPAI_FUKA_UMU);   //9Z770160700000011";	//心肺運動負荷試験(所見の有無)
//		syokenUmu.add(CHOKUCHO_NAISIKYO_UMU);   //9Z770160700000011";	//直腸内視鏡検査(所見の有無)
//		syokenUmu.add(TOUBU_CT_UMU);   //9Z770160700000011";	//頭部CT検査(所見の有無)
//		syokenUmu.add(TOUBU_MRI_UMU);   //9Z770160700000011";	//頭部MRI検査(所見の有無)
//		syokenUmu.add(FUKUBU_CT_UMU);   //9Z770160700000011";	//腹部CT検査(所見の有無)
//		syokenUmu.add(FDG_PET_UMU);   //9Z770160700000011";	//FDG-PET検査(所見の有無)
//		syokenUmu.add(DAICHO_NAISIKYO_UMU);   //9Z770160700000011";	//大腸内視鏡検査(所見の有無)
//		syokenUmu.add(SJYO_NAISIKYO_UMU);   //9Z770160700000011";	//S状結腸内視鏡検査(所見の有無)
//		syokenUmu.add(CHUCHO_ZOUKEI_UMU);   //9Z770160700000011";	//注腸造影検査(所見の有無)
//		syokenUmu.add(CHOKUCHO_UMU);   //9Z770160700000011";	//直腸診(所見の有無)
//		
//	}
//
//	// edit s.inoue 2014/02/19
//	// 見直し
//	private static final void initializeSyoken(){
//		// 1ページ目(具体的な既往歴,自覚症状所見,他覚所見,
//		// 貧血検査実施理由,眼底検査(その他の所見)
//		// 心電図実施理由,眼底検査実施理由,医師の診断(判定)
//		
//		// 3ページ目
//		// 生活機能評価の結果3,医師の診断(判定)(生活機能評価)
//
//		// 心電図（所見）
...
//		
//		// add s.inoue 2014/02/19
//		syoken.add(FUKUYAKU1_VAL);
//		syoken.add(FUKUYAKU1_RIYU_VAL);
//		syoken.add(FUKUYAKU2_VAL);
//		syoken.add(FUKUYAKU2_RIYU_VAL);
//		syoken.add(FUKUYAKU3_VAL);
//		syoken.add(FUKUYAKU3_RIYU_VAL);
//		syoken.add(TOUBU_CT_VAL);
//		syoken.add(TOUBU_MRI_VAL);
//		syoken.add(FUKUBU_CT_VAL);
//		syoken.add(FDG_PET_VAL);
//		syoken.add(DAICHO_NAISIKYO_VAL);
//		syoken.add(SJYO_NAISIKYO_VAL);
//		syoken.add(CHUCHO_ZOUKEI_VAL);
//		syoken.add(CHOKUCHO_VAL);
//		syoken.add(HOLTER_SINDENZU_VAL);
//		syoken.add(MASTER_FUKA_VAL);
//		syoken.add(TREDMIRU_SINDENZU_VAL);
//		syoken.add(ERUGOMETER_SINDENZU_VAL);
//		syoken.add(CHOKUCHO_NAISIKYO_VAL);
//		syoken.add(KOTUEN_DXA_VAL);
//		syoken.add(KOTUEN_DEX_VAL);
//		syoken.add(KOTUEN_MD_VAL);
//		syoken.add(KOTUEN_CXD_VAL);
//		syoken.add(KOTUEN_DIP_VAL);
//		syoken.add(KOTUEN_QCT_VAL);
//		syoken.add(KOTUEN_US_VAL);
//		syoken.add(KOTUEN_PWV_VAL);
//		syoken.add(KOTUEN_PWV_OLD_VAL);
//		syoken.add(KEIDOMYAKU_VAL);
//		syoken.add(SIDOUJICYUI_VAL);
//		
//	}
//
//	static{
