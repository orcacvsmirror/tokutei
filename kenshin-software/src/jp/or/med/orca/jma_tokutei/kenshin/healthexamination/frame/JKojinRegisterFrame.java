...
//	protected ExtendedTextField jTextField_ORCAID = null;
//
//	protected ExtendedTextField jTextField_JyushinkenID = null;
//	protected ExtendedTextField jTextField_IssueDate = null;
//	protected ExtendedTextField jTextField_LimitDate = null;
//	protected ExtendedTextField jTextField_TorimatomeName = null;
//	protected ExtendedTextField jTextField_HihokenjyaCode = null;
//	protected ExtendedTextField jTextField_HihokenjyaNumber = null;
//	protected ExtendedTextField jTextField_NameKana = null;
//	protected ExtendedTextField jTextField_NameKanji = null;
//	protected ExtendedTextField jTextField_NameTsushou = null;
//	protected ExtendedTextField jTextField_Birthday = null;
//	protected ExtendedTextField jTextField_YearOld = null;
//	protected ExtendedTextField jTextField_ZipCode = null;
//	protected ExtendedTextField jTextField_Address = null;
//	protected ExtendedTextField jTextField_HomePhone = null;
//	protected ExtendedTextField jTextField_CellPhone = null;
//	protected ExtendedTextField jTextField_FAXNumber = null;
//	protected ExtendedTextField jTextField_EMail = null;
//	protected ExtendedTextField jTextField_MobileMail = null;
//	protected ExtendedTextField jTextField_MadoguchiKihon = null;
//	protected ExtendedTextField jTextField_MadoguchiShousai = null;
//	protected ExtendedTextField jTextField_MadoguchiTsuika = null;
//	protected ExtendedTextField jTextField_MadoguchiDock = null;
...
//	protected ExtendedTextField jTextField_Uketsukeid = null;
//	protected ExtendedLabel jLabel_Nendo = null;
//	protected ExtendedTextField jTextField_Nendo = null;
...
//	protected ExtendedTextField jTextField_KihonJougen = null;
//	protected ExtendedLabel jLabel_madoguchikihon_unit1 = null;
//	protected ExtendedTextField jTextField_ShousaiJougen = null;
...
//	protected ExtendedTextField jTextField_TsuikaJyougen = null;
//	protected ExtendedTextField jTextField_DockJougen = null;
//	protected ExtendedLabel jLabel2711 = null;
//	protected ExtendedLabel jLabel2712 = null;
//	protected ExtendedTextField jTextField_KihonSyubetsuNum = null;
//	protected ExtendedTextField jTextField_SyousaiSyubetsuNum = null;
//	protected ExtendedTextField jTextField_TsuikaSyubetsuNum = null;
//	protected ExtendedTextField jTextField_DockSyubetsuNum = null;
...
//	protected ExtendedTextField jTextField_sonotaHutangaku = null;
...
//			gridBagConstraints131.insets = new Insets(0, 0, 5, 5);
...
//			jLabel6.setText("契約取りまとめ<br>機関名");
...
//			jPanel_DrawArea.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
...
//			jTextField_ORCAID = new ExtendedTextField("", 20, ImeMode.IME_OFF, false);
...
//
//
//	private ExtendedTextField getJTextField_TorimatomeName() {
//		if (jTextField_TorimatomeName == null) {
//			jTextField_TorimatomeName = new ExtendedTextField(ImeMode.IME_ZENKAKU);
...
//	}
//
//	private ExtendedTextField getJTextField_HihokenjyaCode() {
//		if (jTextField_HihokenjyaCode == null) {
//			jTextField_HihokenjyaCode = new ExtendedTextField(ImeMode.IME_ZENKAKU);
...
//	}
//
//	private ExtendedTextField getJTextField_HihokenjyaNumber() {
//		if (jTextField_HihokenjyaNumber == null) {
//			jTextField_HihokenjyaNumber = new ExtendedTextField(ImeMode.IME_ZENKAKU);
...
//	}
//
//	private ExtendedTextField getJTextField_NameKanji() {
//		if (jTextField_NameKanji == null) {
//			jTextField_NameKanji = new ExtendedTextField(ImeMode.IME_ZENKAKU);
...
//	}
//
//	private ExtendedTextField getJTextField_NameTsushou() {
//		if (jTextField_NameTsushou == null) {
//			jTextField_NameTsushou = new ExtendedTextField(ImeMode.IME_ZENKAKU);
...
//			// edit ver2 s.inoue 2009/07/29
//			//jTextField_Birthday.setPreferredSize(new Dimension(185, 20));
//			jTextField_Birthday.setPreferredSize(new Dimension(120, 20));
//			jTextField_Birthday.addActionListener(this);
//			// edit ver2 s.inoue 2009/07/30
...
//	private ExtendedTextField getJTextField_YearOld() {
//		if (jTextField_YearOld == null) {
//			jTextField_YearOld = new ExtendedTextField();
...
//	}
//
//	private ExtendedTextField getJTextField_HomePhone() {
//		if (jTextField_HomePhone == null) {
//			jTextField_HomePhone = new ExtendedTextField(ImeMode.IME_OFF);
...
//	}
//
//	private ExtendedTextField getJTextField_CellPhone() {
//		if (jTextField_CellPhone == null) {
//			jTextField_CellPhone = new ExtendedTextField(ImeMode.IME_OFF);
...
//	}
//
//	private ExtendedTextField getJTextField_FAXNumber() {
//		if (jTextField_FAXNumber == null) {
//			jTextField_FAXNumber = new ExtendedTextField(ImeMode.IME_OFF);
...
//	}
//
//	private ExtendedTextField getJTextField_EMail() {
//		if (jTextField_EMail == null) {
//			jTextField_EMail = new ExtendedTextField(ImeMode.IME_OFF);
...
//	}
//
//	private ExtendedTextField getJTextField_MobileMail() {
//		if (jTextField_MobileMail == null) {
//			jTextField_MobileMail = new ExtendedTextField(ImeMode.IME_OFF);
...
//			jComboBox_MadoguchiShousaiSyubetu = new ExtendedComboBox();
...
//			jComboBox_MadoguchiDockSyubetu = new ExtendedComboBox();
...
//	}
//
//	private ExtendedTextField getJTextField_MadoguchiKihon() {
//
//		if (jTextField_MadoguchiKihon == null) {
//			jTextField_MadoguchiKihon = new ExtendedTextField("", 6, ImeMode.IME_OFF);
...
//	}
//
//	private ExtendedTextField getJTextField_MadoguchiShousai() {
//		if (jTextField_MadoguchiShousai == null) {
//			jTextField_MadoguchiShousai = new ExtendedTextField("", 6, ImeMode.IME_OFF);
...
//	}
//
//	private ExtendedTextField getJTextField_MadoguchiTsuika() {
//		if (jTextField_MadoguchiTsuika == null) {
//			jTextField_MadoguchiTsuika = new ExtendedTextField("", 6, ImeMode.IME_OFF);
...
//	}
//
//	private ExtendedTextField getJTextField_MadoguchiDock() {
//		if (jTextField_MadoguchiDock == null) {
//			jTextField_MadoguchiDock = new ExtendedTextField("", 6, ImeMode.IME_OFF);
...
//			gridBagConstraints82.insets = new Insets(10, 0, 10, 0);
...
//			gridBagConstraints81.insets = new Insets(0, 10, 10, 0);
...
//			gridBagConstraints80.insets = new Insets(0, 10, 10, 0);
...
//	 */
//	private ExtendedTextField getJTextField_Uketsukeid() {
//		if (jTextField_Uketsukeid == null) {
//			jTextField_Uketsukeid = new ExtendedTextField();
...
//	 * @return jp.or.med.orca.jma_tokutei.common.component.ExtendedTextField
//	 */
//	private ExtendedTextField getJTextField_Nendo() {
//		if (jTextField_Nendo == null) {
//			jTextField_Nendo = new ExtendedTextField();
...
//			jComboBox_DaikouNumber = new ExtendedComboBox();
...
//	 * @return jp.or.med.orca.jma_tokutei.common.component.ExtendedTextField
//	 */
//	private ExtendedTextField getJTextField_MadoguchiKihon1() {
//		if (jTextField_KihonJougen == null) {
//			jTextField_KihonJougen = new ExtendedTextField(
//					"",
//					6,
//					ImeMode.IME_OFF);
...
//	 * @return jp.or.med.orca.jma_tokutei.common.component.ExtendedTextField
//	 */
//	private ExtendedTextField getJTextField_ShousaiJougen() {
//		if (jTextField_ShousaiJougen == null) {
//			jTextField_ShousaiJougen = new ExtendedTextField(
//					"",
//					6,
//					ImeMode.IME_OFF);
...
//	 * @return jp.or.med.orca.jma_tokutei.common.component.ExtendedTextField
//	 */
//	private ExtendedTextField getJTextField_TsuikaJyougen() {
//		if (jTextField_TsuikaJyougen == null) {
//			jTextField_TsuikaJyougen = new ExtendedTextField(
//					"",
//					6,
//					ImeMode.IME_OFF);
...
//	 * @return jp.or.med.orca.jma_tokutei.common.component.ExtendedTextField
//	 */
//	private ExtendedTextField getJTextField_DockJougen() {
//		if (jTextField_DockJougen == null) {
//			jTextField_DockJougen = new ExtendedTextField(
//					"",
//					6,
//					ImeMode.IME_OFF);
...
//	 * @return jp.or.med.orca.jma_tokutei.common.component.ExtendedTextField
//	 */
//	private ExtendedTextField getJTextField_KihonSyubetsuNum() {
//		if (jTextField_KihonSyubetsuNum == null) {
//			jTextField_KihonSyubetsuNum = new ExtendedTextField(
//					"",
//					1,
//					ImeMode.IME_OFF);
...
//	 * @return jp.or.med.orca.jma_tokutei.common.component.ExtendedTextField
//	 */
//	private ExtendedTextField getJTextField_SyousaiSyubetsuNum() {
//		if (jTextField_SyousaiSyubetsuNum == null) {
//			jTextField_SyousaiSyubetsuNum = new ExtendedTextField(
//					"",
//					1,
//					ImeMode.IME_OFF);
...
//	 * @return jp.or.med.orca.jma_tokutei.common.component.ExtendedTextField
//	 */
//	private ExtendedTextField getJTextField_KihonTsuikaNum() {
//		if (jTextField_TsuikaSyubetsuNum == null) {
//			jTextField_TsuikaSyubetsuNum = new ExtendedTextField(
//					"",
//					1,
//					ImeMode.IME_OFF);
...
//	 * @return jp.or.med.orca.jma_tokutei.common.component.ExtendedTextField
//	 */
//	private ExtendedTextField getJTextField_DockSyubetsuNum() {
//		if (jTextField_DockSyubetsuNum == null) {
//			jTextField_DockSyubetsuNum = new ExtendedTextField(
//					"",
//					1,
//					ImeMode.IME_OFF);
...
//			gridBagConstraints127.insets = new Insets(0, 20, 0, 0);
...
//			jPanel_buttons.add(getJButton_Print(), gridBagConstraints123);
//			jPanel_buttons.add(getJButton_QR(), gridBagConstraints124);
//			jPanel_buttons.add(getJButton_Call(), gridBagConstraints126);
...
//	 * @return jp.or.med.orca.jma_tokutei.common.component.ExtendedTextField
//	 */
//	private ExtendedTextField getJTextField_sonotaHutangaku() {
//		if (jTextField_sonotaHutangaku == null) {
//			jTextField_sonotaHutangaku = new ExtendedTextField(
//					"",
//					9,
//					ImeMode.IME_OFF);
