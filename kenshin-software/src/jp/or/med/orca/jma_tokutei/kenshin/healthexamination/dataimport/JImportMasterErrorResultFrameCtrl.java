 ...
 */
public class JImportMasterErrorResultFrameCtrl extends JImportErrorResultFrame
{

	private JSimpleTable model = new JSimpleTable();
	private Vector<JImportErrorResultFrameData> KojinData;
	private JImportErrorResultFrameData SelectedData = null;

	public JImportMasterErrorResultFrameCtrl(Vector<JImportErrorResultFrameData> Data,JFrame ParentFrame)
	{
		super();
