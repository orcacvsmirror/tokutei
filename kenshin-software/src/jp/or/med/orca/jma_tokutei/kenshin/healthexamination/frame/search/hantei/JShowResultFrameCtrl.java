...
//			"情報提供",
	...
	private static org.apache.log4j.Logger logger = Logger.getLogger(JShowResultFrameCtrl.class);
	...
	public JShowResultFrameCtrl(
		...
		rowCount = grid.getVOListTableModel().getRowCount()-1;
...
//				hihokenjyasyoNo, hokenjyaNo, this, pageSelect);
		kekka.printResultCard(vo.getKENSA_NENGAPI(), vo.getUKETUKE_ID(), vo.getHIHOKENJYASYO_KIGOU(),
				vo.getHIHOKENJYASYO_NO(), vo.getHKNJANUM(), this, pageSelect);
	...
	public void pushedFixButton(ActionEvent e) {
		...
		String kigou = vo.getHIHOKENJYASYO_KIGOU();
		String no = vo.getHIHOKENJYASYO_NO();
		String kanaName = vo.getKANANAME();
		String hokenjaNumber = vo.getHKNJANUM();
...
//		srcData.setBirthDay(birthDay);
		...
		// srcData.setNAME(kanaName);
		srcData.setKANANAME(kanaName);

		srcData.setHKNJANUM(hokenjaNumber);
		srcData.setSEX(sex);
		srcData.setBIRTHDAY(Integer.valueOf(birthDay));

		srcData.setKENSA_NENGAPI(vo.getKENSA_NENGAPI());

		// eidt s.inoue 2011/12/07
//		JScene.CreateDialog(
//				this,
//				new JKekkaRegisterFrameCtrl(srcData,vo.getKENSA_NENGAPI(),false),
//				new WindowRefreshEvent());
		JScene.CreateDialog(
				this,
				new JRegisterFlameCtrl(srcData,false),
				new WindowRefreshEvent());
	}
	...
	private void refresh() {
		...
		this.jTextField_HihokenjyaCode.setText(vo.getHIHOKENJYASYO_KIGOU());
		this.jTextField_HihokenjyaNumber.setText(vo.getHIHOKENJYASYO_NO());
		// eidt s.inoue 2011/06/07
		// this.jTextField_Name.setText(vo.getNAME());
		this.jTextField_Name.setText(vo.getKANANAME());
