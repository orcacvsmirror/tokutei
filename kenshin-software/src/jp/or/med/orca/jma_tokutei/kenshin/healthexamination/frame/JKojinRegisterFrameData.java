...
public class JKojinRegisterFrameData {
	 ...
	 * @param jyushinkenID the jyushinkenID to set
	 */
	public boolean setpreJyushinkenID(String prejyushinkenID) {
		isValidationAsDataSet = false;
	 ...
	 */
	public boolean setLimitDate(String limitDate) {
		isValidationAsDataSet = false;
	 ...
	 */
	public boolean setMadoguchiKihon(String madoguchiKihon) {
		isValidationAsDataSet = false;
...
//			return true;
	 ...
	 */
	public boolean setMadoguchiSyousai(String madoguchiSyousai) {
		isValidationAsDataSet = false;
...
//			return true;
	 ...
	 */
	public boolean setMadoguchiTsuika(String madoguchiTsuika) {
		isValidationAsDataSet = false;
...
//			return true;
	 ...
	 */
	public boolean setMadoguchiDock(String madoguchiDock) {
		isValidationAsDataSet = false;
